...
const features = [
  {
    ...
    description: "Precise, human-crafted transcriptions for your audio and video content.",
    startingPrice: "$15",
    icon: (
  ...
  },
  {
    ...
    description: "Streamline your workflow with dedicated virtual support tailored to your needs.",
    startingPrice: "$25",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: "Beautiful, functional designs that capture your vision and engage your audience.",
    startingPrice: "$50",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zM7 21h10a2 2 0 002-2v-5a2 2 0 00-2-2H9a2 2 0 00-2 2v5a2 2 0 01-2 2z" />
      </svg>
    )
  },
  {
